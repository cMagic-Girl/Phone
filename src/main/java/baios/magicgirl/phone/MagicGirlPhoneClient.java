...
import baios.magicgirl.phone.sound.SoundRecorder;
...
@EventBusSubscriber(modid = MagicGirlPhone.MODID, value = Dist.CLIENT)
public class MagicGirlPhoneClient {
    public MagicGirlPhoneClient(ModContainer container) {

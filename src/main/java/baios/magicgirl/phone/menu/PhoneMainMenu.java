...
public class PhoneMainMenu extends AbstractContainerMenu implements ModMenus.MenuAccessor
{
    ...
    public PhoneMainMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
